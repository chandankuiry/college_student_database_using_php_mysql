...
<body background="photo/background-learner.jpg">
	  ...
	  <p></p><h1><marquee><strong><font color="white">Welcome to NIT Durgapur Student Information System</font></strong></marquee></h1><p></p>
	  <div class="container">
  <br>
  <div id="myCarousel" class="carousel slide " data-ride="carousel">
    ...
    <div class="carousel-inner" >
      <div class="item active">
        <img src="photo/nitdgp1.jpg" >
      </div> 

    
      <div class="item ">
        <img src="photo/image153.jpg">
      </div>
    
      <div class="item ">
        <img src="photo/garden.jpg"  >
      </div>
      <div class="item">
        <img src="photo/maxres.jpg">
      </div> 

    
      <div class="item">
        <img src="photo/slide-4.jpg" >
      </div>
 ...
 <a class="left carousel-control" href="#myCarousel" data-slide="prev">
  ...
  <br><br><br><br><br><br>
    ...
    <ul class="site-footer-links">
      ...
      <div class="col-md-1">
       ...
       <a href="https://twitter.com/nitdurgapur" class="btn btn-twitter">
  ...
  <a href="http://www.nitdgp.ac.in/" class="btn btn-google">
    <i class="fa fa-google"></i>| Connect with  Google Page
  </a>
  </li>
  <li>
    
  <a href="https://www.facebook.com/groups/718937774827583/" class="btn btn-facebook">
